...
<body>
  <header class="header">
    <div class="logo-container">
      ...
      <a href="/" class="logo-text">atPay</a>
    </div>
  </header>
  ...
  <main class="main-container">
    <div class="receipt">
      <div class="receipt-header">
        ...
        <div class="transaction-id">TXN ID: #<?= htmlspecialchars($response['transaction_id'] ?? uniqid('ATX')) ?></div>
      </div>
      ...
      <div class="receipt-footer">
        ...
        <div class="timestamp">Generated on: <?= date('l, F j, Y \a\t g:i:s A T') ?></div>
